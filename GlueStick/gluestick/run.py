...
def main():
    ...
    parser.add_argument('-img1', default=join('/home/sunh/6D_ws/other_network/cnos-main/GlueStick-main/resources/img1.jpg'))
    parser.add_argument('-img2', default=join('/home/sunh/6D_ws/other_network/cnos-main/GlueStick-main/resources/img2.jpg'))
